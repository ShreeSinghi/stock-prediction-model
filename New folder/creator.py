...
def load_data():
    ...
    for stock in stocks:
        ...
        data[stock] = pd.read_pickle(f'intra{stock}.pkl')
...
def fetch_data():
    ...
    for stock in stocks:
        ...
        data[stock] = pd.concat([data[stock], df]).sort_index()
        data[stock] = data[stock][~data[stock].index.duplicated(keep='last')]
        data[stock].to_pickle(f'intra{stock}.pkl')
